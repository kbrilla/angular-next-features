...
&#64;if (user?.addr; as <span class="hl-var">a</span><span class="hl-hint">: Addr | <span class="hl-good">undefined</span></span>)</pre></div>
      ...
      <div class="issues-section">
        ...
        <div class="issue-card">
          ...
          <p class="issue-desc">
            TypeScript has supported inlay hints since TS 4.4, but Angular templates never showed type information
            for template variables (<code>&#64;for</code>, <code>&#64;if</code>, <code>&#64;let</code>, <code>#refs</code>),
            event parameters, or pipe outputs. This feature brings 25 configuration options and 118 tested scenarios.
          </p>
        </div>
      </div>
    </div>
